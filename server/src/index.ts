...
const io = new Server(httpServer, {
  cors: {
    origin: [process.env.CLIENT_URL || "http://localhost:5175", "http://localhost:5174", "http://localhost:5173"],
    methods: ["GET", "POST"]
  }
});
...
// CORS configuration
app.use(cors({
  origin: [process.env.CLIENT_URL || "http://localhost:5174", "http://localhost:5176", "http://localhost:5175", "http://localhost:5174", "http://localhost:5173"],
  credentials: true
}));

...
export default function JobDetailPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {/* Old Application Modal - REMOVE THIS SECTION */}
      {false && showApplicationModal && (
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-gray-200 p-6">
              <div>
                ...
                <p className="text-gray-600">at {getCompanyName(job)}</p>
              </div>
              <button
                onClick={() => {
                  setShowApplicationModal(false);
            ...
            <div className="max-h-[60vh] overflow-y-auto p-6">
              ...
              <div className="mb-6">
                ...
                <div className="rounded-lg border-2 border-dashed border-gray-300 p-6 text-center transition-colors hover:border-blue-500">
                  <HiUpload className="mx-auto mb-3 h-12 w-12 text-gray-400" />
            ...
            {/* Modal Footer */}
            <div className="flex items-center justify-end gap-3 border-t border-gray-200 bg-gray-50/50 p-6">
              <Button
                variant="outline"
                onClick={() => {
                  setShowApplicationModal(false);

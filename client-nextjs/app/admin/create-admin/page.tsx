    ...
    <div className="px-4 sm:px-6">
      ...
      >
        ...
        <div className="bg-card border border-border rounded-xl p-4 sm:p-6 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <MdPerson className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground w-5 h-5 pointer-events-none" />
                  <input
                    type="text"
                    name="firstName"
            ...
            <div>
              ...
              <div className="relative">
                <MdEmail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground w-5 h-5 pointer-events-none" />
                <input
                  type="email"
                  name="email"
            ...
            <div>
              ...
              <div className="relative">
                <MdKey className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground w-5 h-5 pointer-events-none" />
                <input
                  type="password"
                  name="password"
            ...
            {/* Action Buttons */}
            <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-3 pt-4 sm:pt-6">
              <Button
                type="submit"
                variant="default"
                size="lg"
        ...
        <motion.div
          ...
          className="mt-6 sm:mt-8 p-4 sm:p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg"
        >

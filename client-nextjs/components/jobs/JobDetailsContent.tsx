...
export default function JobDetailsContent({ initialJob, initialRelatedJobs }: JobDetailsContentProps) {
  ...
  const [relatedJobs, setRelatedJobs] = useState<Job[]>(initialRelatedJobs);
  ...
  useEffect(() => {
    const fetchUserStatus = async () => {
      ...
      try {
        ...
        console.error("Error checking user job status:", err);
      }
    };

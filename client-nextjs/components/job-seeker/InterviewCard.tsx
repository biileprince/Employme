...
export default function InterviewCard({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "COMPLETED":
        return "bg-gray-50 border-gray-200 text-gray-800 dark:bg-gray-800/20 dark:border-gray-700 dark:text-gray-300";
      case "CANCELLED":
  ...
  return (
    <>
      <motion.div
        ...
        className={`relative border-2 rounded-xl p-4 transition-all duration-200 hover:shadow-lg ${getStatusColor(
          interview.status
        )} ${className}`}
      >
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start justify-between">
            ...
            <span
              className={`px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 border-2 ${getStatusColor(
                interview.status
              )}`}
            >
          ...
          <div className="flex gap-2 pt-2">
            <button
              ...
              className="flex items-center justify-center gap-2 flex-1 px-4 py-2 bg-background/60 dark:bg-background/40 hover:bg-background/80 dark:hover:bg-background/60 border border-current/20 rounded-lg text-sm font-medium transition-colors"
            >
            ...
            {interview.isVirtual && interview.meetingLink && isUpcoming && (
              <button
                ...
                className="flex items-center justify-center gap-2 flex-1 px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg text-sm font-medium transition-colors"
              >
          ...
          {isUpcoming && (
            <div className="bg-primary/10 dark:bg-primary/20 border border-primary/30 dark:border-primary/40 p-3 rounded-lg text-center">
              <div className="flex items-center justify-center gap-2 text-primary dark:text-primary-foreground">
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-muted/50 dark:bg-muted/30 p-4 rounded-lg space-y-2 text-foreground">
                  <p>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-muted/50 dark:bg-muted/30 p-4 rounded-lg space-y-3 text-foreground">
              ...
              <div className="flex gap-3 pt-4 border-t border-border">
                {interview.isVirtual && interview.meetingLink && isUpcoming && (
                  <button
                    onClick={() => window.open(interview.meetingLink, "_blank")}
                    className="flex items-center justify-center gap-2 px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg font-medium transition-colors"
                  >
                    <MdVideoCall className="w-4 h-4" />
                    Join Meeting
                  </button>

...
export default function DashboardContent({ stats, recentJobs, recentApplications }: DashboardProps) {
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "SHORTLISTED":
        return "text-purple-600 bg-purple-50 border-purple-200 dark:text-purple-400 dark:bg-purple-900/10 dark:border-purple-800/20";
      case "HIRED":
        return "text-green-600 bg-green-50 border-green-200 dark:text-green-400 dark:bg-green-900/10 dark:border-green-800/20";
      case "REJECTED":
        return "text-red-600 bg-red-50 border-red-200 dark:text-red-400 dark:bg-red-900/10 dark:border-red-800/20";
      default:
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium border ${
                          job.isActive
                            ? "text-green-600 bg-green-50 border-green-200 dark:text-green-400 dark:bg-green-900/10 dark:border-green-800/20"
                      ...
                      <span className="text-muted-foreground text-xs">
                        {job._count?.applications || job.applicationsCount || 0}{" "}
                        applications
                      </span>
                    </div>
                  </div>

...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const register = async (email: string, password: string, firstName: string, lastName: string, role = 'JOB_SEEKER') => {
    setIsLoading(true);
    try {
  ...
  const verifyEmail = async (code: string) => {
    ...
    if (data.success) {
      // Don't auto-login user, just verify the email
      // User will need to login manually after verification
    }
    return data;
  };

    ...
    <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-left bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/jobs">
                  <Button size="lg" className="text-lg px-8 py-4 font-semibold shadow-lg">
                    Browse Jobs
                  </Button>
                </Link>
                <Link to="/signup">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Featured Jobs</h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Discover the latest job opportunities from top companies across Ghana
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              <div key={job.id} className="bg-card text-card-foreground rounded-2xl border border-border p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-primary mb-2 leading-tight">{job.title}</h3>
          ...
          <div className="text-center mt-12">
            <Link to="/jobs">
              <Button variant="outline" size="lg" className="text-lg px-8 py-4 font-semibold">
                View All Jobs
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20 bg-card relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-card-foreground mb-6">How It Works</h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <h3 className="text-2xl md:text-3xl font-bold text-primary mb-4">For Job Seekers</h3>
                <p className="text-lg text-muted-foreground mb-8">Find your dream job in 3 simple steps</p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4 group">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-secondary text-white rounded-full flex items-center justify-center text-sm font-bold">1</div>
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2 text-card-foreground">Create Your Profile</h4>
                    <p className="text-muted-foreground leading-relaxed">Build your professional profile to showcase your skills and experience to potential employers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-secondary text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2 text-card-foreground">Find Matching Jobs</h4>
                    <p className="text-muted-foreground leading-relaxed">Search and filter through thousands of job listings to find opportunities that match your skills.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-secondary text-white rounded-full flex items-center justify-center text-sm font-bold">3</div>
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2 text-card-foreground">Apply with Ease</h4>
                    <p className="text-muted-foreground leading-relaxed">Submit your application with a single click and track your application status in real-time.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <h3 className="text-2xl md:text-3xl font-bold text-secondary mb-4">For Employers</h3>
                <p className="text-lg text-muted-foreground mb-8">Hire top talent efficiently and effectively</p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4 group">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold">1</div>
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2 text-card-foreground">Post Your Jobs</h4>
                    <p className="text-muted-foreground leading-relaxed">Create detailed job listings to attract the right candidates for your open positions.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2 text-card-foreground">Review Candidates</h4>
                    <p className="text-muted-foreground leading-relaxed">Browse through qualified candidates and review their profiles, skills, and experience.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold">3</div>
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2 text-card-foreground">Hire the Best</h4>
                    <p className="text-muted-foreground leading-relaxed">Connect with top talent and build your dream team with our streamlined hiring process.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-muted-foreground font-medium">Job Seekers</div>
            </div>
            <div>
      ...
      <section className="py-20 relative overflow-hidden min-h-[600px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="bg-black/20 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
              ...
              <p className="text-xl text-white mb-8 leading-relaxed font-medium drop-shadow-md">
                Join thousands of job seekers who have found their dream jobs through Employ.me. 
        ...
        <div className="absolute top-0 right-0 w-1/3 h-full opacity-20">
          <svg viewBox="0 0 200 200" className="w-full h-full text-white">
            ...
            <circle cx="150" cy="50" r="30" fill="currentColor" opacity="0.05" />
            <circle cx="50" cy="150" r="40" fill="currentColor" opacity="0.08" />
          </svg>
        </div>
      </section>

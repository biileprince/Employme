...
// Request data type
type RequestData = Record<string, unknown> | FormData | CreateJobData | UpdateProfileData | null;
...
export const jobsAPI = {
  ...
  update: (id: string, jobData: Partial<CreateJobData>) => apiClient.put(`/jobs/${id}`, jobData),
  ...
  createJob: (jobData: Record<string, unknown>) => apiClient.post('/jobs', jobData),
...
export const applicationsAPI = {
  ...
  getEmployerApplications: () =>
    apiClient.get('/applications/employer'),
...
export const userAPI = {
  ...
  updateProfile: (profileData: UpdateProfileData) => apiClient.put('/users/me', profileData),
